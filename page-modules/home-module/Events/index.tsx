...
const Events = () => {
  ...
  return (
    <>
    <EventOverlay isOpen = {isEventOpen} onClose = {toggleEventOverlay} header = "Events" futureEvents = {futureEvents}/>
    <Container>
      ...
      <div className="flex justify-between w-[100%] mt-10">
        ...
        <p className="font-bold text-otaku-red-2 cursor-pointer" onClick={handleFutureEvents}>View All</p>
      </div>
      ...
      <div className="mt-8 w-[100%] h-[600px] grid grid-rows-[20%_80%]" >
        <div className="flex justify-between w-[100%] mt-10">
          ...
          <p className="font-bold text-otaku-red-2 cursor-pointer" onClick={handlePreviousEvents}>View All</p>
        </div>
